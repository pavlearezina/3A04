...
\label{sub:overview}
% Begin SubSection
The rest of the SRS entails three more sections covering the requiremnts of the project and an appendix that describes the division of labour. The first part is the overall describtion that describes  the general factors that affect the product and its requirements. It does not state specific requirements; it provides a background for those requirements and makes them easier to understand. Functional requirments and non-functional requirements.
\begin{enumerate}[a)]
